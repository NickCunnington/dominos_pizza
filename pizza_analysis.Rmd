...
kcal_crust %>%
  ...
  ggtitle("Average amount of calories per crust type (per 100g)\n") +
  theme_bw() +
...
kcal_name %>%
  ...
  ggtitle("Average amount of calories per pizza type (per 100g)\n") +
  theme_bw() +
...
fat_crust %>%
  ...
  geom_col(fill = "darkblue") +
  xlab("\nPizza Name") +
  ylab("Average amount of Fat (g)\n") +
  ggtitle("Average amount of fat per crust name (per 100g)\n") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15, face = "bold")) +
  theme(axis.title.x = element_text(size = 14)) +
  theme(axis.title.y = element_text(size = 14)) 
...
fat_name %>%
  ...
  xlab("Pizza Type\n") +
  ylab("\nAverage Fat (g)") +
  ggtitle("Average amount of Fat per pizza type (per 100g)\n") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15, face = "bold")) +
  theme(axis.title.x = element_text(size = 14)) +
  theme(axis.title.y = element_text(size = 14)) 
...
sat_crust %>%
  ...
  ggtitle("Average amount of Saturated Fat per pizza name (per 100g)\n") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15, face = "bold")) +
  theme(axis.title.x = element_text(size = 14)) +
  theme(axis.title.y = element_text(size = 14)) 
...
sat_name %>%
  ...
  ggtitle("Average amount of saturated fat per pizza type (per 100g)\n") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15, face = "bold")) +
  theme(axis.title.x = element_text(size = 14)) +
  theme(axis.title.y = element_text(size = 14)) 
...
carb_crust %>%
  ...
  geom_col(fill = "darkblue") +
  xlab("\nPizza Type") +
  ylab("Average Carbs (g)\n") +
  ggtitle("Average amount of carbs per pizza type (per 100g)\n") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15, face = "bold")) +
  theme(axis.title.x = element_text(size = 14)) +
  theme(axis.title.y = element_text(size = 14)) 
...
sugar_crust %>%
  ...
  geom_col(fill = "darkblue") +
  xlab("\nCrust Type") +
  ylab("Average Sugars (g)\n") +
  ggtitle("Average amount of sugar per crust type (per 100g)\n") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15, face = "bold")) +
  theme(axis.title.x = element_text(size = 14)) +
  theme(axis.title.y = element_text(size = 14))
...
sugar_name %>%
  ...
  xlab("Pizza Name\n") +
  ylab("\nAverage Sugar (g)") +
  ggtitle("Average amount of sugar per pizza type (per 100g)\n") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15, face = "bold")) +
  theme(axis.title.x = element_text(size = 14)) +
  theme(axis.title.y = element_text(size = 14))
...
fibre_crust %>%
  ...
  geom_col(fill = "darkblue") +
  xlab("\nCrust type") +
  ylab("Average Fibre (g)\n") +
  ggtitle("Average amount of Fibre per pizza type (per 100g)\n") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15, face = "bold")) +
  theme(axis.title.x = element_text(size = 14)) +
  theme(axis.title.y = element_text(size = 14))
...
protein_crust %>%
  ...
  geom_col(fill = "darkblue") +
  xlab("\nCrust Type") +
  ylab("Average Protein (g)\n") +
  ggtitle("Average amount of Protein per crust type (per 100g)\n") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15, face = "bold")) +
  theme(axis.title.x = element_text(size = 14)) +
  theme(axis.title.y = element_text(size = 14))
...
protein_name %>%
  ...
  xlab("Pizza Type\n") +
  ylab("\nAverage Protein (g)") +
  ggtitle("Average amount of Protein per pizza type (per 100g)\n") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15, face = "bold")) +
  theme(axis.title.x = element_text(size = 14)) +
  theme(axis.title.y = element_text(size = 14))
...
salt_crust %>%
  ...
  xlab("\nCrust Type") +
  ylab("Average Salt (g)\n") +
  ggtitle("Average amount of Salt per crust type (per 100g)\n") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15, face = "bold")) +
  theme(axis.title.x = element_text(size = 14)) +
  theme(axis.title.y = element_text(size = 14))
...
salt_name %>%
  ...
  xlab("Pizza Type\n") +
  ylab("\nAverage Salt (g)") +
  ggtitle("Average amount of Salt per pizza type (per 100g)\n") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15, face = "bold")) +
  theme(axis.title.x = element_text(size = 14)) +
  theme(axis.title.y = element_text(size = 14))
...
sodium_crust %>%
  ...
  geom_col(fill = "darkblue") +
  xlab("\nCrust Type") +
  ylab("Average Sodium (g)\n") +
  ggtitle("Average amount of Sodium per crust type (per 100g)\n") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15, face = "bold")) +
  theme(axis.title.x = element_text(size = 14)) +
  theme(axis.title.y = element_text(size = 14))
...
sodium_name %>%
  ...
  xlab("Pizza Type\n") +
  ylab("\nAverage Sodium (g)") +
  ggtitle("Average amount of Sodium per pizza type (per 100g)\n") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15, face = "bold")) +
  theme(axis.title.x = element_text(size = 14)) +
  theme(axis.title.y = element_text(size = 14))
...
kcal_rda_name %>%
  ...
  xlab("Pizza Type\n") +
  ylab("\nPercent RDA") +
  ggtitle("RDA of calories per pizza type (per serving)\n") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15, face = "bold")) +
  theme(axis.title.x = element_text(size = 14)) +
  theme(axis.title.y = element_text(size = 14))
...
fat_rda %>%
  ...
  xlab("Pizza Type\n") +
  ylab("\nPercent RDA") +
  ggtitle("RDA of fat per pizza type (per serving)\n") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15, face = "bold")) +
  theme(axis.title.x = element_text(size = 14)) +
  theme(axis.title.y = element_text(size = 14))
...
sat_rda %>%
  ...
  xlab("Pizza Type\n") +
  ylab("\nPercent RDA") +
  ggtitle("RDA of saturated fat per pizza type (per serving)\n") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15, face = "bold")) +
  theme(axis.title.x = element_text(size = 14)) +
  theme(axis.title.y = element_text(size = 14))
...
carb_rda %>%
  ...
  xlab("Pizza Type\n") +
  ylab("\nPercent RDA") +
  ggtitle("RDA of Carbs per pizza type (per serving)\n") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15, face = "bold")) +
  theme(axis.title.x = element_text(size = 14)) +
  theme(axis.title.y = element_text(size = 14))
...
sugar_rda %>%
  ...
  xlab("Pizza Type\n") +
  ylab("\nPercent RDA") +
  ggtitle("RDA of sugar per pizza type (per serving)\n") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15, face = "bold")) +
  theme(axis.title.x = element_text(size = 14)) +
  theme(axis.title.y = element_text(size = 14))
...
fibre_rda %>%
  ...
  xlab("Pizza Type\n") +
  ylab("\nPercent RDA") +
  ggtitle("RDA of fibre per pizza type (per serving)\n") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15, face = "bold")) +
  theme(axis.title.x = element_text(size = 14)) +
  theme(axis.title.y = element_text(size = 14))
...
protein_rda %>%
  ...
  xlab("Pizza Type\n") +
  ylab("\nPercent RDA") +
  ggtitle("RDA of protein per pizza type (per serving)\n") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15, face = "bold")) +
  theme(axis.title.x = element_text(size = 14)) +
  theme(axis.title.y = element_text(size = 14))
...
salt_rda %>%
  ...
  xlab("Pizza Type\n") +
  ylab("\nPercent RDA") +
  ggtitle("RDA of salt per pizza type (per serving)\n") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15, face = "bold")) +
  theme(axis.title.x = element_text(size = 14)) +
  theme(axis.title.y = element_text(size = 14))
...
sodium_rda %>%
  ...
  xlab("Pizza Type\n") +
  ylab("\nPercent RDA") +
  ggtitle("RDA of sodium per pizza type (per serving)\n") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15, face = "bold")) +
  theme(axis.title.x = element_text(size = 14)) +
  theme(axis.title.y = element_text(size = 14))
