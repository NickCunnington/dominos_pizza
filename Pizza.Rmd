...
crust_calories %>%
  ...
  xlab("Crust Type\n") +
  ylab("\nRDA (%)") +
  ggtitle("%RDA of Calories for Crust Type (per serving)\n") +
  theme_bw() +
...
crust_protein %>%
  ...
  xlab("Crust Type\n") +
  ylab("\nRDA (%)") +
  ggtitle("%RDA of Protein for Crust Type (per serving)\n") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15, face = "bold")) +
  theme(axis.title.x = element_text(size = 14)) +
  theme(axis.title.y = element_text(size = 14))
...
crust_fat %>%
  ...
  xlab("Crust Type\n") +
  ylab("\nRDA (%)") +
  ggtitle("%RDA of Fat for Crust Type (per serving)\n") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15, face = "bold")) +
  theme(axis.title.x = element_text(size = 14)) +
  theme(axis.title.y = element_text(size = 14))
...
crust_sat %>%
  ...
  xlab("Crust Type\n") +
  ylab("\nRDA (%)") +
  ggtitle("%RDA of Saturated Fat for Crust Type (per serving)\n") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15, face = "bold")) +
  theme(axis.title.x = element_text(size = 14)) +
  theme(axis.title.y = element_text(size = 14))
...
crust_carbs %>%
  ...
  xlab("Crust Type\n") +
  ylab("\nRDA (%)") +
  ggtitle("%RDA of Carbs for Crust Type (per serving)\n") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15, face = "bold")) +
  theme(axis.title.x = element_text(size = 14)) +
  theme(axis.title.y = element_text(size = 14))
...
crust_sugar %>%
  ...
  xlab("Crust Type\n") +
  ylab("\nRDA (%)") +
  ggtitle("%RDA of Sugar for Crust Type (per serving)\n") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15, face = "bold")) +
  theme(axis.title.x = element_text(size = 14)) +
  theme(axis.title.y = element_text(size = 14))
...
crust_fibre %>%
  ...
  xlab("Crust Type\n") +
  ylab("\nRDA (%)") +
  ggtitle("%RDA of Fibre for Crust Type (per serving)\n") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15, face = "bold")) +
  theme(axis.title.x = element_text(size = 14)) +
  theme(axis.title.y = element_text(size = 14))
...
crust_salt %>%
  ...
  xlab("Crust Type\n") +
  ylab("\nRDA (%)") +
  ggtitle("%RDA of Carbs for Salt Type (per serving)\n") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15, face = "bold")) +
  theme(axis.title.x = element_text(size = 14)) +
  theme(axis.title.y = element_text(size = 14))
...
pizza_calories %>%
  ggplot() +
  aes(x = name, y = avg_percent_RDA) +
  geom_col(fill = "darkblue", col = "white") +
  coord_flip() +
  xlab("Pizza Name\n") +
  ylab("\nRDA (%)") +
  ggtitle("%RDA of Calories for Pizza Name (per serving)\n") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15, face = "bold")) +
  theme(axis.title.x = element_text(size = 14)) +
  theme(axis.title.y = element_text(size = 14))
...
pizza_protein %>%
  ...
  xlab("Pizza Name\n") +
  ylab("\nRDA (%)") +
  ggtitle("%RDA of Protein for Pizza Name (per serving)\n") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15, face = "bold")) +
  theme(axis.title.x = element_text(size = 14)) +
  theme(axis.title.y = element_text(size = 14))
...
pizza_fat %>%
  ...
  xlab("Pizza Name\n") +
  ylab("\nRDA (%)") +
  ggtitle("%RDA of Fat for Pizza Name (per serving)\n") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15, face = "bold")) +
  theme(axis.title.x = element_text(size = 14)) +
  theme(axis.title.y = element_text(size = 14))
...
pizza_calories %>%
  ...
  xlab("Pizza Name\n") +
  ylab("\nRDA (%)") +
  ggtitle("%RDA of Saturated Fat for Pizza Name (per serving)\n") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15, face = "bold")) +
  theme(axis.title.x = element_text(size = 14)) +
  theme(axis.title.y = element_text(size = 14))
...
pizza_carbs %>%
  ...
  xlab("Pizza Name\n") +
  ylab("\nRDA (%)") +
  ggtitle("%RDA of Carbs for Pizza Name (per serving)\n") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15, face = "bold")) +
  theme(axis.title.x = element_text(size = 14)) +
  theme(axis.title.y = element_text(size = 14))
...
pizza_sugar %>%
  ...
  xlab("Pizza Name\n") +
  ylab("\nRDA (%)") +
  ggtitle("%RDA of Sugar for Pizza Name (per serving)\n") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15, face = "bold")) +
  theme(axis.title.x = element_text(size = 14)) +
  theme(axis.title.y = element_text(size = 14))
...
pizza_fibre %>%
  ...
  xlab("Pizza Name\n") +
  ylab("\nRDA (%)") +
  ggtitle("%RDA of Fibre for Pizza Name (per serving)\n") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15, face = "bold")) +
  theme(axis.title.x = element_text(size = 14)) +
  theme(axis.title.y = element_text(size = 14))
...
pizza_salt %>%
  ...
  xlab("Pizza Name\n") +
  ylab("\nRDA (%)") +
  ggtitle("%RDA of Salt for Pizza Name (per serving)\n") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15, face = "bold")) +
  theme(axis.title.x = element_text(size = 14)) +
  theme(axis.title.y = element_text(size = 14))
